...
RUN echo y | sdkmanager "platform-tools" "build-tools;27.0.3" "build-tools;26.0.2" "build-tools;25.0.3" "platforms;android-27" "platforms;android-26" "platforms;android-25" "extras;google;m2repository" "extras;android;m2repository" "extras;google;google_play_services"
